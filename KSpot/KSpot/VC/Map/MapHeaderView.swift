...
class MapHeaderView: UICollectionReusableView {
    ...
    @IBOutlet weak var guroBtn: RegionBtn!
    @IBOutlet weak var yeongdeungpoBtn: RegionBtn!
    ...
    @IBOutlet weak var gangnamBtn: RegionBtn!
    @IBOutlet weak var seochoBtn: RegionBtn!
    @IBOutlet weak var jungguBtn: RegionBtn!
    @IBOutlet weak var eunpyeongBtn: RegionBtn!
