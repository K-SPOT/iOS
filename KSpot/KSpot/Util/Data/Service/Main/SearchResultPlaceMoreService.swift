//
//  SearchResultPlaceMoreService.swift
//  KSpot
//
...
import Foundation
struct SearchResultPlaceMoreService : GettableService {
    typealias NetworkData = SearchResultPlaceMoreVO
    static let shareInstance = SearchResultPlaceMoreService()
    func getSearchResultPlaceMore(url : String, completion : @escaping (NetworkResult<Any>) -> Void){
        get(url) { (result) in
            switch result {
