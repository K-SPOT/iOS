...
class WRCycleCell: UICollectionViewCell
{
    ...
    var descLabelFont: UIFont = UIFont(name: NanumSquareOTF.NanumSquareOTFR.rawValue, size: 14)! {
        didSet {
    ...
    var descLabelTextAlignment:NSTextAlignment = .right {
        didSet {
            descLabel.textAlignment = descLabelTextAlignment
        }
    }
    var bottomViewBackgroundColor: UIColor = UIColor.black.withAlphaComponent(0.0) {
        didSet {
